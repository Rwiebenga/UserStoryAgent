# Implementation Guide for US-374402

## User Story
**Title:** Title: As a user, I want to search embassies by country  Description: Allow users to filter the embassy list by selecting a country from a dropdown
